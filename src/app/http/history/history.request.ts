...
const getHistoryJobValidation = object({
	...
	tanggal_awal: optional(string(ERROR_VALIDATION_MSG.string('tanggal_awal'))),
	tanggal_akhir: optional(string(ERROR_VALIDATION_MSG.string('tanggal_akhir')))
});

export type TGetHistoryJobValidation = InferOutput<
	typeof getHistoryJobValidation
>;

export default {
	getHistoryJobValidation
};
