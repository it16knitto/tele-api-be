...
async function create_pipelinesinglescriptartifact(datajob) {
...
module.exports = {
  create_pipelinesinglescriptartifact: create_pipelinesinglescriptartifact,
};
